...
const config = {
    name: "Frenky", // actual name of the recipient (Mandatory)

    nickname: "Frenky", // nickname(optional)

    pic: "https://telegra.ph/file/cfcc22f25f701f4b4acb2.jpg", //image url of recipients (Mandatory)
